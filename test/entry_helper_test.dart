...
import 'helpers/hidden_text_helper.dart';
...
void main() {
  group('EntryHelper.processParagraph', () {
    ...
    test('should return a sanitised paragraph and a list with one hidden segment if hidden at the beginning', () {
      String paragraph = '${HiddenTextHelper.hiddenText('This is a hidden segment.')}This is a normal segment.';
      var (sanitisedSegment, hiddenSegments) = EntryHelper.processParagraph(paragraph);
    ...
    test('should return a sanitised paragraph and a list with one hidden segment if hidden at the end', () {
      String paragraph = 'This is a normal segment.${HiddenTextHelper.hiddenText('This is a hidden segment.')}';
    ...
    test('should return a sanitised paragraph and a list with one hidden segment if hidden in the middle', () {
      String paragraph =
          'This is a normal segment.${HiddenTextHelper.hiddenText('This is a hidden segment.')}This is another normal segment.';
    ...
    test('should return a sanitised paragraph and a list with multiple hidden segments if multiple hidden', () {
      String paragraph =
          '${HiddenTextHelper.hiddenText('This is a hidden segment.')}This is a normal segment.${HiddenTextHelper.hiddenText('This is another hidden segment.')}This is another normal segment.${HiddenTextHelper.hiddenText('This is the last hidden segment.')}';
